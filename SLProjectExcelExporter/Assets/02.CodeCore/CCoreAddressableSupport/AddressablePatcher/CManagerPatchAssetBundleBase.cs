...
abstract public class CManagerPatchAssetBundleBase : CManagerTemplateBase<CManagerPatchAssetBundleBase>
{
	...
	//-----------------------------------------------------
	protected CPatcherBase.SPatchEvent ProtPatchAssetBundleInitialize(bool bResetEventHandler, string strDownloadURL)
    {
        DownloadURL = strDownloadURL;
        CPatcherBase.SPatchEvent Handler = m_pPatcherAddressable.InterPatcherInitialize(this, strDownloadURL, string.Empty, true);
