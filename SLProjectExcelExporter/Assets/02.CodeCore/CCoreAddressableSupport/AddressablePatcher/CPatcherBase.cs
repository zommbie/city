...
abstract public class CPatcherBase : CObjectBase
{
    ...
    //---------------------------------------------------------
    internal SPatchEvent InterPatcherInitialize(MonoBehaviour pCoroutine, string strDownloadURL, string strDownloadSavePath,  bool bResetHandler)
    {
        if (bResetHandler)
        {
        ...
        OnPatcherInitialize(strDownloadURL, strDownloadSavePath);
