...
public abstract class CManagerUIFrameFocusBase : CManagerUIFrameBase
{
	...
	private void PrivMgrUIFrameFocusPanelShow(CUIFrameBase pUIFrame)
	{
		...
		pUIFrame.InterUIFrameShow(pUIFrame.p_SortOrder);
	...
	//------------------------------------------------------------------
	private void PrivMgrUIFrameArrageRefresh(LinkedList<CUIFrameBase> pListOrder, int iBaseOrder)
	{
