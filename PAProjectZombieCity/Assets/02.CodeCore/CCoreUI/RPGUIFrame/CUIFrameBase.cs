...
public abstract class CUIFrameBase : CMonoBase, IPointerClickHandler
{
	...
	private int					    m_iSortOrder = 0;			public int  GetUIFrameSortOrder() { return m_iSortOrder; }
                                                                public int  GetUIFrameSortLayerID() { return m_pCanvas.sortingLayerID; }
	...
	internal void InterUIFrameShow(int iOrder)
	{
		...
		m_bShow = true;
		m_bDisAppear = false;
        m_pGraphicRaycaster.enabled = true;
    ...
    protected virtual void OnUIFrameScriptDataLoaded() { }  // 모든 메니저와 테이블이 로딩되었다. 
