...
public abstract class CUIWidgetBase : CUIEntryBase
{
    ...
    //------------------------------------------------------
    protected void ProtUIWidgetAddChild(CUIWidgetBase pChildUIWidget)
    {
        CUIFrameWidgetBase pUIFrameWidget = GetUIEntryParentsUIFrame() as CUIFrameWidgetBase;
        pUIFrameWidget.InterUIWidgetAdd(pChildUIWidget);
    }

    protected void ProtUIWidgetRemoveChild(CUIWidgetBase pChildUIWidget)
    {
        CUIFrameWidgetBase pUIFrameWidget = GetUIEntryParentsUIFrame() as CUIFrameWidgetBase;
        pUIFrameWidget.InterUIWidgetDelete(pChildUIWidget);
    }
	//--------------------------------------------------------
    ...
    private void RecursiveUIWidgetChildTransform(Transform pRecursiveTransform)
    {
        ...
        for (int i = 0; i < iTotalCount; i++) 
        {
            ...
            {
                pChildWidget.InterUIEntryOwner(this);
