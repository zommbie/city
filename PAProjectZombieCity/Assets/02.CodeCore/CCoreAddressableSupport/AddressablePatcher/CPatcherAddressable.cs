...
public class CPatcherAddressable : CPatcherBase
{
    ...
    private UnityAction            m_delInitializeFinish = null;
    private List<string>           m_listPatchLable = null;
    private StringBuilder          mNote = new System.Text.StringBuilder();
    private ResourceLocationMap    m_pResourceLocationMap = null;   
    //---------------------------------------------------
    protected override void OnPatcherInitialize(string strDownloadURL, string strDownloadSavePath, UnityAction delFinish)
    {
        m_delInitializeFinish = delFinish;
    ...
    private void HandlePatchInitialize(AsyncOperationHandle<IResourceLocator> Result)
    {
        if (Result.Status == AsyncOperationStatus.Succeeded)
        {
            ...
            m_delInitializeFinish?.Invoke();

            m_pResourceLocationMap = Result.Result as ResourceLocationMap;
        }
    }
