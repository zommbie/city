...
*/
public static class CEasingFunction
{
	...
	public static Function GetEasingFunction(EEasingType easingFunction)
	{
		if (easingFunction == EEasingType.EaseInQuad)
		{
			return EaseInQuad;
		}

		if (easingFunction == EEasingType.EaseOutQuad)
		{
			return EaseOutQuad;
		}

		if (easingFunction == EEasingType.EaseInOutQuad)
		{
			return EaseInOutQuad;
		}

		if (easingFunction == EEasingType.EaseInCubic)
		{
			return EaseInCubic;
		}

		if (easingFunction == EEasingType.EaseOutCubic)
		{
			return EaseOutCubic;
		}

		if (easingFunction == EEasingType.EaseInOutCubic)
		{
			return EaseInOutCubic;
		}

		if (easingFunction == EEasingType.EaseInQuart)
		{
			return EaseInQuart;
		}

		if (easingFunction == EEasingType.EaseOutQuart)
		{
			return EaseOutQuart;
		}

		if (easingFunction == EEasingType.EaseInOutQuart)
		{
			return EaseInOutQuart;
		}

		if (easingFunction == EEasingType.EaseInQuint)
		{
			return EaseInQuint;
		}

		if (easingFunction == EEasingType.EaseOutQuint)
		{
			return EaseOutQuint;
		}

		if (easingFunction == EEasingType.EaseInOutQuint)
		{
			return EaseInOutQuint;
		}

		if (easingFunction == EEasingType.EaseInSine)
		{
			return EaseInSine;
		}

		if (easingFunction == EEasingType.EaseOutSine)
		{
			return EaseOutSine;
		}

		if (easingFunction == EEasingType.EaseInOutSine)
		{
			return EaseInOutSine;
		}

		if (easingFunction == EEasingType.EaseInExpo)
		{
			return EaseInExpo;
		}

		if (easingFunction == EEasingType.EaseOutExpo)
		{
			return EaseOutExpo;
		}

		if (easingFunction == EEasingType.EaseInOutExpo)
		{
			return EaseInOutExpo;
		}

		if (easingFunction == EEasingType.EaseInCirc)
		{
			return EaseInCirc;
		}

		if (easingFunction == EEasingType.EaseOutCirc)
		{
			return EaseOutCirc;
		}

		if (easingFunction == EEasingType.EaseInOutCirc)
		{
			return EaseInOutCirc;
		}

		if (easingFunction == EEasingType.Linear)
		{
			return Linear;
		}

		if (easingFunction == EEasingType.Spring)
		{
			return Spring;
		}

		if (easingFunction == EEasingType.EaseInBounce)
		{
			return EaseInBounce;
		}

		if (easingFunction == EEasingType.EaseOutBounce)
		{
			return EaseOutBounce;
		}

		if (easingFunction == EEasingType.EaseInOutBounce)
		{
			return EaseInOutBounce;
		}

		if (easingFunction == EEasingType.EaseInBack)
		{
			return EaseInBack;
		}

		if (easingFunction == EEasingType.EaseOutBack)
		{
			return EaseOutBack;
		}

		if (easingFunction == EEasingType.EaseInOutBack)
		{
			return EaseInOutBack;
		}

		if (easingFunction == EEasingType.EaseInElastic)
		{
			return EaseInElastic;
		}

		if (easingFunction == EEasingType.EaseOutElastic)
		{
			return EaseOutElastic;
		}

		if (easingFunction == EEasingType.EaseInOutElastic)
		{
	...
	public static Function GetEasingFunctionDerivative(EEasingType easingFunction)
	{
		if (easingFunction == EEasingType.EaseInQuad)
		{
			return EaseInQuadD;
