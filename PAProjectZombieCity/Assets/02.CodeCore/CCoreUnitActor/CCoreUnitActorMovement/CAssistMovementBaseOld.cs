...
public interface IUnitEventMoveOld
{

}

public abstract class CAssistMovementBaseOld : CAssistUnitActorBase
{
    ...
    private IUnitEventMoveOld m_pEventMoveOwner = null;
    ...
    //------------------------------------------------------------------
    public IUnitEventMoveOld GetAssistEventOwner()
    {
